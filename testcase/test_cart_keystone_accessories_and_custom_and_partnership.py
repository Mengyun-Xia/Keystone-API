...
class Test_Cart_Keystone_Accessories_And_Custom_And_Partnership:
    ...
    product_id = "gid://shopify/ProductVariant/43315178012825"   #Keystone partnership okx
    quantity = 1
    goods = { 
    "cart_id":cart_id,
    "products": [{"product":product_id},{"quantity":quantity}]}
    ...
    product_id1 = "gid://shopify/ProductVariant/35292891119769"   #Keystone Tablet Plus
    quantity = 1
    goods = { 
    "cart_id":cart_id,
    "products": [{"product":product_id},{"quantity":quantity}]}
